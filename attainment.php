...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#gender').multiselect({includeSelectAllOption: true});
                $('#curriculum').multiselect({includeSelectAllOption: true});
                                $('#nationality').multiselect({includeSelectAllOption: true});
        ...
        $(document).on("ready click", function () {
            ...
            var selected_gender = $("#gender option:selected");
                        var selected_gender = $("#curriculum option:selected");
                        var selected_gender = $("#nationality option:selected");
    ...
    <div class=" w3-responsive header" >
        ...
        <div id="upperdiv" class="w3-container w3-mobile" style="padding-top: 10px; padding-bottom: 10px">
            <table id= "table1">
                ...
                <tr>
                    <td>Curriculum</td><td>Term</td>
                    <td>Grade</td>  <td>Section</td>  <td>Subject</td><td>Nationality</td><td></td>
                </tr>
                <tr>
                 <td>
                        <select id="curriculum"  multiple="multiple"> 
                            <option>MoE</option>
                            <option>US</option> 
                        </select>
                    </td>
